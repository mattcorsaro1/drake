...
Robotiq3fCommandReceiver::Robotiq3fCommandReceiver(int num_joints)
    : num_joints_(num_joints) {
  this->DeclareAbstractInputPort(
      systems::kUseDefaultName,
      Value<lcmt_robotiq_3f_command>{});
...
void Robotiq3fCommandReceiver::DoCalcDiscreteVariableUpdates(
  ...
  const auto& command = input->get_value<lcmt_robotiq_3f_command>();
